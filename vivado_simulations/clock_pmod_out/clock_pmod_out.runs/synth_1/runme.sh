...
HD_PWD='/home/wilfred/vivado_workspace/clock_pmod_out/clock_pmod_out.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_out.tcl
