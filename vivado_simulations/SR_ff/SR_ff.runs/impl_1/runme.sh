...
HD_PWD='/home/wilfred/Desktop/github/Digital-Design-and-Computer-Architecture/vivado_simulations/SR_ff/SR_ff.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sr_ff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sr_ff.tcl -notrace
